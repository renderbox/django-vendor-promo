# Generated by Django 3.1.11 on 2021-05-14 00:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='name',
            field=models.CharField(default='Pname', max_length=80, verbose_name='Name'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            model_name='product',
            name='slug',
            field=autoslug.fields.AutoSlugField(default='slug', editable=False, populate_from='name', unique_with=('site__id',)),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='product',
