...
VENDOR_PROMO_PROCESSOR_URL = os.getenv("VENDOR_PROMO_PROCESSOR_URL", None)
VENDOR_PROMO_PROCESSOR_BARRER_KEY = os.getenv("VENDOR_PROMO_PROCESSOR_BARRER_KEY", None)
