# Generated by Django 3.2.19 on 2023-05-16 17:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default=None, help_text='Enter a description or objective for thie campaign', null=True, verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promo', to='vendorpromo.promotionalcampaign')),
            ],
            options={
