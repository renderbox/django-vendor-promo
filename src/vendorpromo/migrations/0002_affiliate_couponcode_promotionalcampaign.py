# Generated by Django 3.2.19 on 2023-05-23 11:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applies_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promo_campaign', to='vendor.offer')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promo_campaign', to='sites.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ManyToManyField(blank=True, related_name='coupon_code', to='vendor.Invoice')),
                ('promo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coupon_code', to='vendorpromo.promotionalcampaign')),
            ],
            options={
